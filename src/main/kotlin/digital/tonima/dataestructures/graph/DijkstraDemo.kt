...
fun main() {
    ...
    graph1.addEdge("A", "B", weight = 4)
    graph1.addEdge("A", "C", weight = 2)
    graph1.addEdge("B", "D", weight = 5)
    graph1.addEdge("C", "D", weight = 8)
    graph1.addEdge("C", "E", weight = 10)
    graph1.addEdge("D", "E", weight = 2)
    ...
    graph2.addEdge(1, 2, weight = 7)
    graph2.addEdge(1, 3, weight = 9)
    graph2.addEdge(1, 6, weight = 14)
    graph2.addEdge(2, 3, weight = 10)
    graph2.addEdge(2, 4, weight = 15)
    graph2.addEdge(3, 4, weight = 11)
    graph2.addEdge(3, 6, weight = 2)
    graph2.addEdge(4, 5, weight = 6)
    graph2.addEdge(5, 6, weight = 9)
    ...
    println("────────────────────────────────────────")
    val graph3 = Graph<String>()
    graph3.addEdge("A", "B", weight = 5)
    graph3.addEdge("B", "C", weight = 3)
    graph3.addEdge("X", "Y", weight = 2)
